...
#define LCD_GPIO_DB4_Pin LCD_D4_Pin
#define LCD_GPIO_DB5_Pin LCD_D5_Pin
#define LCD_GPIO_DB6_Pin LCD_D6_Pin
#define LCD_GPIO_DB7_Pin LCD_D7_Pin
//#define LCD_GPIO_DB0_Port
//#define LCD_GPIO_DB1_Port
//#define LCD_GPIO_DB2_Port
//#define LCD_GPIO_DB3_Port
#define LCD_GPIO_DB4_Port LCD_D4_GPIO_Port
#define LCD_GPIO_DB5_Port LCD_D5_GPIO_Port
#define LCD_GPIO_DB6_Port LCD_D6_GPIO_Port
#define LCD_GPIO_DB7_Port LCD_D7_GPIO_Port
